...
{% Aside 'caution' %}
This audit was removed from [Lighthouse v10.0.0](https://github.com/GoogleChrome/lighthouse/releases/tag/v10.0.0) on February 9th 2023. For more information on the removal of this audit, see the relevant [GitHub PR](https://github.com/GoogleChrome/lighthouse/pull/14194).
{% endAside %}
