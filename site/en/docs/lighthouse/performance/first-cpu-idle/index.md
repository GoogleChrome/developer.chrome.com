...
offers a more meaningful measurement than [Time To Interactive](http://web.dev/tti/), the difference isn't significant enough to justify maintaining two similar metrics. Moving forward, consider using [Total Blocking Time](/docs/lighthouse/performance/lighthouse-total-blocking-time/) and [Time To Interactive](http://web.dev/tti/) instead.
{% endAside %}
