...
---
{% Aside 'caution' %}
  Time to Interactive was [deprecated in Lighthouse 8.0 (https://github.com/GoogleChrome/lighthouse/blob/main/docs/v8-perf-faq.md) and [removed in Lighthouse 10.0](https://developer.chrome.com/blog/lighthouse-10-0). Largest Contentful Paint (LCP) and Speed Index are usually better heuristics.
{% endAside %}
