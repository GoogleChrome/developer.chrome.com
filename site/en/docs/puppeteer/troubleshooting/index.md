...
description: >
  Fixing some specific issues you might run into
date: 2018-01-11
updated: 2022-06-16
...
This means that the browser was downloaded but failed to be extracted correctly. The most common cause is a bug in Node.js v14.0.0 which broke `extract-zip`, the module Puppeteer uses to extract browser downloads into the right place. The bug was fixed in Node.js v14.1.0, so make sure you're running that version or higher.
