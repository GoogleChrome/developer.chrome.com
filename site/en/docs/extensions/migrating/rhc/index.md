...
1. [User Scripts API][user-scripts-api]
...
2. [chrome.debugger][chrome.debugger]
...
{% Img src="image/DXqUldooyJOUnj3qXSYLHbUgUI93/SyeEuVZINxlaVnCHqqo2.jpg", alt="screenshot of the URL bar in Chrome that has the message 'Debugger Extension started debugging this browser'", width="800", height="188" %}


3. [Sandboxed iframes][sandboxed_iframes]
