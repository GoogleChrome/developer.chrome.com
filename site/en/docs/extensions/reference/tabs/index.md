...
[`pendingUrl`][prop-pendingurl], [`title`][prop-title], or [`favIconUrl`][prop-faviconurl]
properties of [`tabs.Tab`][tab], you must declare the `"tabs"` permission in the manifest, as shown
below:
