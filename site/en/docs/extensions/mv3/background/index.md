...
Extensions monitor these events using scripts in their background [service worker][sw-migration],
which then react with specified instructions.
...
[sw-migration]: /docs/extensions/mv3/migrating_to_service_workers
