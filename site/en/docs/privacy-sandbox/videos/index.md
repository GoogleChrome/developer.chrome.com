...
Danny Rojas of the Products Parnerships team discusses the Privacy Sandbox from a high level and for a wider audience. He briefly describes each Privacy Sandbox API, some of the community feedback about them, and provides a general timeline for the Privacy Sandbox releases. He also briefly covers common use cases.
{% endColumn %}
{% endColumns %}
