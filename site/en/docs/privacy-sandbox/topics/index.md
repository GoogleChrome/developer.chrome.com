...
A Privacy Sandbox Relevance and Measurement [origin trial](/docs/privacy-sandbox/unified-origin-trial/) has been made available in Chrome Beta 101.0.4951.26 and above on desktop for the Topics, [Protected Audience API](/docs/privacy-sandbox/fledge/), and [Attribution Reporting](/docs/privacy-sandbox/attribution-reporting/) APIs.
...
<dt>
    ...
    <dt>
      ...
      <dd><strong>Default value:</strong> enabled</dd>
      <dd>Enables ads APIs: Attribution Reporting, Protected Audience API, Topics, Fenced Frames.</dd>
    </dt><br />
    <dt>
