...
token is provided in an external script, not a meta tag or inline script</a></label>
  <br>
...
or an inline script. It doesn't matter if the external script that injects the token comes from the
