...
updated: 2022-01-28
description: |
  The Storage Foundation API proposed a storage API that resembles a basic file system,
  with direct access to stored data through buffers and offsets.
---

{% Aside 'warning' %} The Storage Foundation API was part of the
[capabilities project](/blog/fugu-status/) and its development has now been abandoned. After carefully
