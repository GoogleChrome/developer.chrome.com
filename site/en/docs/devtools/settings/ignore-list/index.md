...
DevTools adds third-party scripts to the ignore list based on the [x_google_ignoreList](https://developer.chrome.com/articles/x-google-ignore-list/) property in source maps. Frameworks and bundlers need to supply this information.
