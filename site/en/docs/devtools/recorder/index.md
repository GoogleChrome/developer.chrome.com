...
For example, the CSS `class` values might be autogenerated for applications developed with modern JavaScript frameworks (e.g. [React](https://reactjs.org/), [Angular](https://angular.io/), [Vue](https://vuejs.org/)) and CSS frameworks.
