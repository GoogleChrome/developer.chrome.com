...
For applications developed with modern JavaScript frameworks, (for example, [React](https://reactjs.org/), [Angular](https://angular.io/), [Vue](https://vuejs.org/), and CSS frameworks), the CSS `class` values might be autogenerated. For example:
...
There are already some common popular test selectors in the market and the **Recorder** supports them as well. If you have the following common test selectors defined, the **Recorder** will automatically detect and use them first:
