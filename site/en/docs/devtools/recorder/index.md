...
There are already some common test selectors for automation and the **Recorder** supports them as well. If you have the following common test selectors defined, the **Recorder** will automatically detect and use them first:
