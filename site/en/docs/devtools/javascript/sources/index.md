...
When developing web applications using frameworks (for example, [React](https://reactjs.org/), [Angular](https://angular.io/)), it can be difficult to navigate sources due to the minified files generated by the build tools (for example, [Webpack](https://webpack.js.org/), [Vite](https://vitejs.dev/)).
