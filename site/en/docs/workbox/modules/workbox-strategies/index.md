...
but you can [learn more in the Offline Cookbook](https://web.dev/articles/offline-cookbook).
...
The [stale-while-revalidate](https://web.dev/articles/offline-cookbook#stale_while_revalidate)
...
[cache first](https://web.dev/articles/offline-cookbook#cache_falling_back_to_network)
is the best option.
...
[network first](https://web.dev/articles/offline-cookbook#network_falling_back_to_cache)
...
[network only](https://web.dev/articles/offline-cookbook#network_only)
...
The [cache only](https://web.dev/articles/offline-cookbook#cache_only)
...
- `cacheMatch`: Matches a request from the cache, and invokes the `cacheKeyWillBeUsed()` and
  `cachedResponseWillBeUsed()` plugin lifecycle methods
- `cachePut`: Puts a request/response pair in the cache, and invokes the `cacheKeyWillBeUsed()`,
...
- `waitUntil`: Adds a promise to the extend lifetime promises of the event associated with the
