...
DOM](https://web.dev/articles/shadowdom-v1) as a way to attach "internal"
elements to their [Custom
Elements](https://web.dev/articles/custom-elements-v1), it is also an
...
article](https://web.dev/articles/shadowdom-v1#creating_closed_shadow_roots_should_avoid).
{% endAside %}
