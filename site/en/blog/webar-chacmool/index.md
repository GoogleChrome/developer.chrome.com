...
{% Aside %}
Please excuse our construction debris. The Chacmool demo is currently out of order. Such is the downside of new technology. We hope to bring him back soon.
{% endAside %}
...
{% Aside %}
If you want to be notified of spec updates as they land in Chrome, the
...
notified of those updates watch [its repo on GitHub](https://github.com/immersive-web/webxr-reference).
{% endAside %}
