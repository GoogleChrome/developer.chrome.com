...
title: Pointing the way forward
description: >
...
{% Aside %}
Pointer events are confusingly unrelated to the [`pointer-events CSS
property`](https://developer.mozilla.org/docs/Web/CSS/pointer-events).
