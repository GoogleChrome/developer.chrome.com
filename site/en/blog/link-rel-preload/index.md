...
So what's happening here? The [`href` attribute](https://developer.mozilla.org/docs/Web/HTML/Element/link#attr-href) used in that example should
...
any relevant [Content Security Policy](http://www.html5rocks.com/tutorials/security/content-security-policy/)
