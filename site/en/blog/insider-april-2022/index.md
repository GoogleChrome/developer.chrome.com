...
* **Call to action:** [Migrate your site to UA Client Hints](https://web.dev/articles/migrate-to-ua-ch) or [participate in the deprecation trial](/blog/user-agent-reduction-deprecation-trial/).
...
* **Call to action:** [Learn more](https://web.dev/articles/local-fonts) about the API and [how to use](https://web.dev/articles/local-fonts#how_to_use_the_local_font_access_api) it to start implementing.
