...
To generate such charts yourself, please check out the [Colab](https://colab.research.google.com/) here (you can safely ignore the initial warning when loading it):

[https://colab.research.google.com/github/GoogleChrome/CrUX/blob/main/colab/crux-history-api.ipynb](https://colab.research.google.com/github/GoogleChrome/CrUX/blob/main/colab/crux-history-api.ipynb) [[source]](https://github.com/GoogleChrome/CrUX/blob/main/colab/crux-history-api.ipynb)
...
_Hero image by [Dave Herring](https://unsplash.com/@daveherring) on [Unsplash](https://unsplash.com/photos/pqB2IeI2U1s?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)_
