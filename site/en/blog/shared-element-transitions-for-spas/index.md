...
**Shared transition elements must have [`contain: paint`](/content-visibility/#containment).** This makes it difficult to transition elements that have paint effects outside their content rectangle, such as shadows, blurs, and outlines. Hopefully this will change in future.
