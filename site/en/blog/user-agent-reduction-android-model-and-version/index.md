...
To continue to get accurate values you will need to call the User-Agent Client Hints API (“UA-CH”) which is accessed via [JavaScript or HTTP Headers](#request-detailed-data-with-user-agent-client-hints).
