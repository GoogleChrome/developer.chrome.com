...
Apparently the Java to JavaScript compiler generated a single object with a whopping _82,203 functions_ on it - this was clearly starting to become interesting. Next we went back to V8's `JSStackFrame::GetMethodName()` in order to understand whether there's some low hanging fruit that we could pick there.
