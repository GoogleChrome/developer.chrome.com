...
With the DWARF5 debug format we also get access to another useful feature. It introduces a _name index_ in the debug data that will be generated when passing the `-gpubnames` flag:
