...
Note that it has [always been problematic](https://web.dev/speed-rendering/) for developers to assume a default refresh rate of 60 Hz for all users, since that is not true for many current devices.
