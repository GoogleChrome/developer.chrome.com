...
[Touch.radiusX](https://developer.mozilla.org/docs/Web/API/Touch/radiusX) 
and 
[Touch.radiusY](https://developer.mozilla.org/docs/Web/API/Touch/radiusY). 
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/2ODWB1LMFWdKPoUMznhN.png", alt="Touch angle rotation screenshot", width="600", height="435" %}
</figure>
...
* [Precision Touch Gestures](https://developers.google.com/web/updates/2014/09/Precision-Touch-for-Precise-Gestures) 
