...
The [back/forward cache](https://web.dev/bfcache/) (or "bfcache" for short) is a
term used to describe a navigation optimization some browsers implement that
makes using the back and forward buttons faster.
