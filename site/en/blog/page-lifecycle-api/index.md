...
hero: 'image/C47gYyWYVMMhDmtYSLOWazuyePF2/JD044VYpU8bhSkWg0rm0.png'
alt: >
  'Page Lifecycle API'
tags:
  - performance
...
<a href="/web/updates/images/2018/07/page-lifecycle-api-state-event-flow.png">
  {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/nRaySCz8AJtfSIri4slO.png", alt="Page Lifecycle API state and event flow", width="800", height="541" %}
</a>
...
<a href="/web/updates/images/2018/07/chrome-discards.png">
    {% Img src="image/C47gYyWYVMMhDmtYSLOWazuyePF2/u0GrlEvM4gvh8bm5dbxz.png", alt="Chrome Discards UI", width="800", height="142" %}
</a>
