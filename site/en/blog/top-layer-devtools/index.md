...
[modal dialogs](https://developer.mozilla.org/docs/Web/HTML/Element/dialog) lements in a [fullscreen mode](https://developer.mozilla.org/docs/Web/API/Fullscreen_API).
