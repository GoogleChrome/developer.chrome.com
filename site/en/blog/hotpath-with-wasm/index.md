...
{% Aside %}
Due to legal concerns, I won’t name any browsers in this article.
{% endAside %}
...
{% Aside %}
Compilers like Emscripten still use the WebAssembly
...
to choose from ("dmalloc", "emmalloc", "wee_alloc", etc.).
...
<figure>
{% Video src="video/T4FyVKpzu4WKF1kBNvXepbi08t52/gGhKsqPY2fuD5D22hnTW.mp4", autoplay="true", loop="true", muted="true" %}
</figure>
...
{% Aside %}
I skipped the "boring" parts in the code samples and focused on the actual
...
{% Aside %}
The reason we chose to start at address 4 and not 0 is because address 0
...
{% Aside %}
We are working with the Emscripten team to make the glue code smaller or
...
{% Aside %}
Since the release of this article, we have learned more about how to
...
```
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/jIqoNhIJyh9Q47y66h4I.png", alt="Twiggy installation screenshot", width="800", height="149" %}
</figure>
...
{% Aside %}
According to Twiggy, the main contributor to the file size is `core::fmt`,
...
{% Aside %}
Ideally, we should have automated this process of reloading the page and
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/emPsMMOrHxJTuWLYCf7D.svg", alt="Speed comparison per language", width="600", height="371" %}
</figure>

<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/eX7OiF4jN6CrWUd9B03s.svg", alt="Speed comparison per browser", width="600", height="371" %}
</figure>
...
<figure>
{% Img src="image/T4FyVKpzu4WKF1kBNvXepbi08t52/BeFqrV8vYLsrNQKF9euc.svg", alt="Comparison graph", width="600", height="371" %}
</figure>

{% Aside %}
Again, please note that _both_ axis are logarithmic and that the x axis
