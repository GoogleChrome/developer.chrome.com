...
selector](https://web.dev/articles/learn/css/selectors#class_selector) is nested within
...
selector](https://web.dev/articles/learn/css/selectors#grouping_selectors).
...
selector](https://web.dev/articles/learn/css/selectors#compound_selectors), where
...
.circle`; [descendant
selectors](https://web.dev/articles/learn/css/selectors#descendant_combinator).
