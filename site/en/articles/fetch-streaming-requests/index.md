...
Each `value` is a `Uint8Array` of bytes.
...
{% Aside %}
This isn't an issue for HTTP/2 or 3, as data is always 'chunked', although it calls the chunks [frames](https://web.dev/articles/performance-http2#streams,_messages,_and_frames).
{% endAside %}
