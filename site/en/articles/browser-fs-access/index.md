...
[The File System Access API: simplifying access to local files](/articles/file-system-access/).
{% endAside %}
...
[installable PWA](https://web.dev/explore/progressive-web-apps#make-it-installable)
