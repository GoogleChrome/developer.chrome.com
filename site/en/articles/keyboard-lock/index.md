...
authors:
  - thomassteiner
description: The Keyboard Lock API allows websites to capture keys that are normally reserved by the underlying operating system. It is intended for web applications that provide a full screen immersive experience (like games or remote access apps).
date: 2020-07-28
updated: 2022-04-04
...
<figure>
  {% Img src="image/tcFciHGuF3MxnTr1y5ue01OGLBn2/6iFOOM7ImdtiMJHlbCnz.png", alt="Ubuntu Linux streamed to a browser tab in macOS Chrome (not running in full screen mode yet).", width="800", height="496" %}
  <figcaption>
