...
{% Aside 'success' %}
The Content Indexing API, part of the [capabilities project](/blog/fugu-status/),
...
Share Target API](https://web.dev/web-share-target). The [code demonstrates a
...
using the [Cache Storage API](https://web.dev/cache-api-quick-guide).
