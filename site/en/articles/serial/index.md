...
alt: Old modems, routers, network equipment. Serial, phone, audio, ethernet connectors.
description: The Web Serial API bridges the web and the physical world by allowing websites to communicate with serial devices.
tags:
  - capabilities
  - devices
feedback:
...
{% Aside 'success' %}
The Web Serial API, part of the [capabilities project](/blog/fugu-status/), launched
in Chrome 89.
{% endAside %}
...
devices to their computers. These devices are oft fen controlled by
