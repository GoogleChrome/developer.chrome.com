...
[Chrome's installability criteria](https://web.dev/install-criteria),
...
[Periodic background sync](https://web.dev/periodic-background-sync) allows a service worker
