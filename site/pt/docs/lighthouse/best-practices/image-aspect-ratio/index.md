...
Por fim, confira a postagem [Exibir imagens com dimensões corretas](https://web.dev/articles/serve-images-with-correct-dimensions) para aprender como exibir imagens com o tamanho certo para o dispositivo de cada usuário.
