...
### 导出为带有 Lighthouse 分析的 Puppeteer 脚本 {: #puppeteer-lighthouse }
...
探索自定义您的记录器体验的选项，例如，使用自定义导出选项。 在录影里， 通过单击 {% Img src="image/NJdAV9UgKuN8AhoaPBquL7giZQo1/4dU9UXvsinS4zbgjd8rK.svg", alt="Export.", width="20", height="20" %} **Export** > **Get extensions** 以获取 **Recorder** 的扩展。
...
早在 [Chrome 58](/blog/devtools-javascript-cpu-profile-migration-2/) 中，DevTools 团队就计划最终弃用 **JavaScript Profiler**，并让 Node.js 和 Deno 开发人员使用 **Performance** 面板，用于分析 JavaScript CPU 性能。
...
[**Rendering**](/docs/devtools/rendering/#open-rendering) 选项卡为 [Emulate vision deficiencies](/docs/devtools/rendering/apply-effects/#emulate-vision-deficiencies）列表—**对比度降低**。 使用此选项，您可以了解您的网站对对比敏感度较低的人的看法。
...
**Lighthouse** > {% Img src="image/NJdAV9UgKuN8AhoaPBquL7giZQo1/9gzXiTYY0nZzBxGI6KrV.svg", alt="设置.", width="24", height="24" %} > {% Img src="image/NJdAV9UgKuN8AhoaPBquL7giZQo1/ZtDyFg7cjkxacORB3GQn.svg", alt="空复选框。", width="24", height="24" %} **Legacy navigation** 现在默认禁用。 此选项使用旧版 [Lighthouse configuration](https://github.com/GoogleChrome/lighthouse/blob/main/docs/configuration.md) 在导航模式下。
