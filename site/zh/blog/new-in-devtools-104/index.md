...
例如, 这个 [网页](https://jec.fish/demo/perf-measure) 使用 [`performance.measure()`](https://web.dev/articles/usertiming#calculating_measurements_with_measure())方法进行文字载入耗时的计算。
