...
- 페이지에 [첫 번째 콘텐츠풀 페인트](https://web.dev/articles/fcp)에 의해 측정되는 유용한 콘텐츠가 표시됩니다.
...
- [타사 리소스 최적화](https://web.dev/articles/fast#optimize_your_third_party_resources)
