...
{% Aside %} 이 선언이 적용되려면 애플리케이션이 설치되어 있어야 합니다. [앱을 설치 가능하게 만드는 방법](https://web.dev/explore/progressive-web-apps#make-it-installable)에 대한 바로 이 사이트의 기사 시리즈에서 자세히 알아볼 수 있습니다. {% endAside %}
