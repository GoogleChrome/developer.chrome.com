...
사용자가 오프라인인 경우에도 빠르게 로드되고 안정적으로 작동할 수 있도록, 서비스 워커를 사용하여 `action`페이지를 [프리캐싱](https://developers.google.com/web/ilt/pwa/caching-files-with-service-worker)하십시오. [Workbox](/docs/workbox/)는 서비스 워커에서 [프리캐싱을 구현](/precache-with-workbox/)하는 데 도움이 되는 툴입니다.
