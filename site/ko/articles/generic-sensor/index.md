...
개발 중에 `localhost`를 통해 센서를 사용할 수 있습니다. 모바일 장치용으로 개발 중인 경우 로컬 서버용 [포트 포워딩](/docs/devtools/remote-debugging/local-server/)을 설정하면 바로 사용할 수 있습니다!
...
어떤 경우에는 물리적 장치가 없어도 Generic Sensor API를 사용해볼 수 있습니다. Chrome DevTools는 [장치 방향 시뮬레이션](/docs/devtools/device-mode/orientation/)을 훌륭하게 지원합니다.
...
Generic Sensor API의 [권한 정책 통합](/docs/privacy-sandbox/permissions-policy/)은 프레임의 센서 데이터에 대한 액세스를 제어합니다.
