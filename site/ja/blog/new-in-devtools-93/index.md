...
-->
[Attribution Reporting](https://developer.chrome.com/docs/privacy-sandbox/attribution-reporting/)は（広告のクリックや視聴のような）ユーザーアクションがコンバージョンを引き起こすタイミングについて、クロスサイトの識別子を伴わずに測定するための新しいAPIです。
