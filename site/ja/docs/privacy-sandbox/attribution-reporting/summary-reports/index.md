...
まだ読んでいないのであれば、この記事の以降の内容を読む前に、[Attribution Reporting の全般的な概要](/docs/privacy-sandbox/attribution-reporting-introduction/)を読むことをお勧めします。
...
1. 集計可能なレポートが、アドテクプロバイダーが運営する_レポートオリジン_に送信されます。
