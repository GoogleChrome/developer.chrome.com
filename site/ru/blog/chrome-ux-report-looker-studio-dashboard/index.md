...
На первой странице представлен месячный обзор метрик производительности [Core Web Vitals](https://web.dev/articles/vitals). Это самые важные показатели UX, на которых Google рекомендует сосредоточиться.
...
Распределения для этих факторов рассчитываются с использованием сегментов данных гистограммы [FCP (Первой отрисовки контента)](https://web.dev/articles/fcp).
