...
литералы JSON](/blog/new-in-devtools-90/#double-quotes). Мы получили отзывы от
разработчиков, что это изменение слегка может сбивать с толку. Некоторые считают,
что экранирование слишком велико и делает вывод нечитаемым. 
...
Кликните на две новые иконки рядом с сообщением об ошибке, связанной с CORS, чтобы просмотреть сетевой
...
снимке экрана). Выберите метрику, сосредоточиться на возможностях и диагностике, наиболее релевантных для улучшения именно этой метрики. 
