...
- [Время загрузки для взаимодействия](https://web.dev/articles/tti) (Time to Interactive, TTI) — показывает, как быстро страница становится полностью интерактивной.
