...
// Generated on Mon Dec 07 2020 21:49:25 GMT+1100 (Australian Eastern Daylight Time)
 ...
 */
  export namespace automation {
    ...
    export type DescriptionFromType = "uninitialized" | "attribute" | "contents" | "relatedElement" | "title";
    ...
    /**
     * The type of an input event associated with an {@link
     ...
     */
    export type IntentTextBoundaryType = "character" | "format" | "lineEnd" | "lineStart" | "lineStartOrEnd" | "object" | "pageEnd" | "pageStart" | "pageStartOrEnd" | "paragraphEnd" | "paragraphStart" | "paragraphStartOrEnd" | "sentenceEnd" | "sentenceStart" | "sentenceStartOrEnd" | "webPage" | "wordEnd" | "wordStart" | "wordStartOrEnd";
    ...
    export interface Marker {
      ...
      /**
       * A mapping of MarkerType to true or undefined indicating the marker types for
       * this marker.
       */
     ...
     * focus.
     * @param callback Called with the <code>AutomationNode</code> that currently has accessibility focus.
     * @param callback.focusedNode
     */
 ...
 */
  export namespace certificateProvider {
    ...
    export interface SetCertificatesDetails {
      /**
       * When called in response to {@link onCertificatesUpdateRequested}, should
    ...
    export interface ReportSignatureDetails {
      /**
       * Request identifier that was received via the {@link onSignatureRequested}
       * event.
       */
      signRequestId: number;
    ...
    /**
     * Should be called as a response to {@link onSignatureRequested}. <p>The
    ...
    /**
     * This event fires if the certificates set via {@link setCertificates} are
     * insufficient or the browser requests updated information. The extension
     * must call {@link setCertificates} with the updated list of certificates
     * and the received <code>certificatesRequestId</code>.
     */
    export const onCertificatesUpdateRequested: chrome.events.Event<
      /**
       * @param request
       */
      (
     ...
     * certificate provided by this extension via {@link setCertificates}.
     * <p>The extension must sign the input data from <code>request</code> using
     * the appropriate algorithm and private key and return it by calling {@link
     * reportSignature} with the received <code>signRequestId</code>.</p>
     */
    export const onSignatureRequested: chrome.events.Event<
      /**
       * @param request
       */
      (
 ...
 */
  export namespace cookies {
     ...
     * @param callback
     * @param callback.cookie Contains details about the cookie that's been set.  If setting failed for any reason, this will be "null", and {@link runtime.lastError} will be set.
     */
    export function set(
      details: {
        /**
     ...
     * @param details
     * @param callback
     * @param callback.details Contains details about the cookie that's been removed.  If removal failed for any reason, this will be "null", and {@link runtime.lastError} will be set.
     */
    export function remove(
      details: CookieDetails,
      callback?: (
 ...
 */
  export namespace declarativeNetRequest {
    ...
    export interface MatchedRule {
      ...
      /**
       * ID of the {@link Ruleset} this rule belongs to. For a rule originating from
    ...
    export interface UpdateRulesetOptions {
      /**
       * The set of ids corresponding to a static {@link Ruleset} that should be
       * disabled.
       */
    ...
    /**
     * The number of rules that an extension can specify across its enabled static
     * rulesets that will not count towards the global total. Up to this number of
     * rules can be enabled regardless of the number of rules that count towards the
     * global total. <!-- TODO(crbug.com/983299): Add documentation once
    ...
    /**
     * The maximum number of combined dynamic or session scoped rules an extension
     * can add. <!--TODO(crbug.com/1043200): Add documentation once implementation
     * is complete. Also deprecate MAX_NUMBER_OF_DYNAMIC_RULES. -->
     */
    export const MAX_NUMBER_OF_DYNAMIC_OR_SESSION_RULES: number;
     ...
     * TODO(crbug.com/1043200): Add documentation once implementation is complete.
     * Also describe it in MatchedRule.rulesetId. -->
     */
     ...
     * removed using this function.</li> <li>{@link MAX_NUMBER_OF_DYNAMIC_RULES} is
     * the maximum number of dynamic rules an extension can add.</li> </ul>
     * @param options
     ...
     * MAX_NUMBER_OF_DYNAMIC_OR_SESSION_RULES} is the maximum number of combined
     * dynamic or session rules an extension can add.</li> </ul>
     * @param options
     * @param callback Called once the update is complete or has failed. In case of an error, {@link runtime.lastError} will be set and no change will be made to the rule set. This can happen for multiple reasons, such as invalid rule format, duplicate rule ID, rule count limit exceeded, and others. <!-- TODO(crbug.com/1043200): Add documentation once implementation is complete. -->
     */
     ...
     * @param callback Called with the set of session scoped rules. <!-- TODO(crbug.com/1043200): Add documentation once implementation is complete. -->
     * @param callback.rules
     */
     ...
     * static rule limit is reached. <!-- TODO(crbug.com/983299): Add documentation
     * once implementation is complete. -->
     * @param callback
     ...
     */
    export const onRuleMatchedDebug: chrome.events.Event<
      /**
       * @param info The rule that has been matched along with information about the associated request.
       */
      (
...
declare namespace chrome {
  ...
  export namespace devtools.inspectedWindow {
    ...
    export interface Resource {
       ...
       * @param callback.encoding Empty if the content is not encoded, encoding name otherwise. Currently, only base64 is supported.
       */
      getContent(
        callback: (
          content: string,
 ...
 */
  export namespace enterprise.networkingAttributes {
     ...
     * @param callback.networkAddresses
     */
...
declare namespace chrome {
  ...
  export namespace i18n {
    ...
    export function getMessage(
      ...
      options?: {
        /**
         * Escape <code>&lt;</code> in translation to <code>&amp;lt;</code>. This
 ...
 */
  export namespace identity {
     ...
     * @param callback Called with an OAuth2 access token as specified by the manifest, or undefined if there was an error. The <code>grantedScopes</code> parameter is populated since Chrome 87. When available, this parameter contains the list of granted scopes corresponding with the returned token.
     * @param callback.token
     * @param callback.grantedScopes
     */
     ...
     * @param callback Called with the <code>ProfileUserInfo</code> of the primary Chrome account, of an empty <code>ProfileUserInfo</code> if the account with given <code>details</code> doesn't exist.
 ...
 */
  export namespace input.ime {
    ...
    export const onKeyEvent: chrome.events.Event<
       ...
       * @param requestId ID of the request. If the event listener returns undefined, then <code>keyEventHandled</code> must be called later with this <code>requestId</code>.
     ...
     */
    export const onAssistiveWindowButtonClicked: chrome.events.Event<
      /**
       * @param details
       */
      (
 ...
 */
  export namespace loginScreenStorage {
    /**
     * Stores persistent data from the login screen. This data can be accessed later
     ...
     * active.
     * @param extensionIds IDs of the extensions that should have access to the stored data.
     * @param data The data to store.
     * @param callback
     */
    export function storePersistentData(
      extensionIds: string[],
      data: string,
      callback: () => void,
    ): void;
    ...
    /**
     * Retrieves persistent data that was previously stored using {@link
     * storePersistentData} for the caller's extension ID.
     * @param ownerId ID of the extension that saved the data that the caller is trying to retrieve.
     * @param callback
     * @param callback.data
     */
    export function retrievePersistentData(
      ownerId: string,
      callback: (
        data: string,
      ) => void,
    ...
    /**
     * Stores credentials for later access from the user session. This method will
     * fail if called while a user session is active.
     * @param extensionId ID of the in-session extension that should have access to these credentials. Credentials stored using this method are deleted on session exit.
    ...
    /**
     * Retrieves credentials that were previosly stored using {@link
 ...
 */
  export namespace loginScreenUi {
     ...
     * @param options Options for the custom login UI window.
     * @param callback Callback that does not take arguments.
     */
    export function show(
      options: ShowOptions,
      callback?: () => void,
 ...
 */
  export namespace loginState {
    ...
    /**
     * Dispatched when the session state changes. <code>sessionState</code> is
     * the new session state.
     */
    export const onSessionStateChanged: chrome.events.Event<
      /**
       * @param sessionState
       */
      (
 ...
 */
  export namespace login {
    /**
     * Launches a managed guest session if one is set up via the admin console. If
     * there are several managed guest sessions set up, it will launch the first
     * available one.
     * @param password If provided, the launched managed guest session will be lockable, and can only be unlocked by calling <code>unlockManagedGuestSession()</code> with the same password.
     * @param callback Note: If the function succeeds, the callback is not guaranteed to be called as the extension will be disabled when the session starts. Use this callback only to handle the failure case by checking {@link runtime.lastError}.
     */
    export function launchManagedGuestSession(
      password?: string,
      callback?: () => void,
    ): void;
     ...
     * @param dataForNextLoginAttempt If set, stores data which can be read by <code>fetchDataForNextLoginAttempt()</code> from the login screen. If unset, any currently stored data will be cleared.
     * @param callback
     */
    export function exitCurrentSession(
      dataForNextLoginAttempt?: string,
      callback?: () => void,
    ): void;
     ...
     * @param callback Called with the stored data, or an empty string if there was no previously stored data.
     * @param callback.result
     */
    export function fetchDataForNextLoginAttempt(
      callback: (
        result: string,
      ) => void,
    ): void;
     ...
     * @param callback
     */
    export function lockManagedGuestSession(
      callback?: () => void,
    ): void;
     ...
     * @param password The password which will be used to unlock the session.
     * @param callback Note: If the function succeeds, the callback is not guaranteed to be called as the extension will be disabled when the session starts. Use this callback only to handle the failure case by checking {@link runtime.lastError}.
     */
    export function unlockManagedGuestSession(
      password: string,
      callback?: () => void,
    ): void;
  }
 ...
 */
  export namespace platformKeys {
    ...
    /**
     * Passes the key pair identified by <code>publicKeySpkiDer</code> for usage
 ...
 */
  export namespace printingMetrics {
    ...
    /**
     * Event fired when the print job is finished. This includes any of
     * termination statuses: FAILED, CANCELED and PRINTED.
     */
    export const onPrintJobFinished: chrome.events.Event<
      /**
       * @param jobInfo
       */
      (
 ...
 */
  export namespace printing {
     ...
     */
    export const MAX_SUBMIT_JOB_CALLS_PER_MINUTE: number;

    /**
     * The maximum number of times that {@link getPrinterInfo} can be called per
     * minute.
     */
    export const MAX_GET_PRINTER_INFO_CALLS_PER_MINUTE: number;
    ...
    /**
     * Event fired when the status of the job is changed. This is only fired for
     * the jobs created by this extension.
     */
    export const onJobStatusChanged: chrome.events.Event<
      /**
       * @param jobId
       * @param status
       */
 ...
 */
  export namespace scripting {
    ...
    export interface InjectionTarget {
      ...
      /**
       * The <a
       * href="https://developer.chrome.com/extensions/webNavigation#frame_ids">IDs</href> of specific frames to inject into.
       */
      frameIds?: number[];
     ...
     * @param callback Invoked upon completion of the injection. The resulting array contains the result of execution for each frame.
     * @param callback.results
     */
 ...
 */
  export namespace system.display {
    ...
    export interface DisplayUnitInfo {
       ...
       */
      isInTabletPhysicalState?: boolean;
 ...
 */
  export namespace tabCapture {
     ...
     * @param callback Callback with either the tab capture MediaStream or   <code>null</code>.  <code>null</code> indicates an error has occurred   and the client may query {@link runtime.lastError} to access the error   details.
 ...
 */
  export namespace tabGroups {
     ...
     * @param callback
     * @param callback.group Details about the updated group.
     */
    export function update(
      groupId: number,
      updateProperties: {
     ...
     * @param callback
     * @param callback.group Details about the moved group.
     */
    export function move(
      groupId: number,
      moveProperties: {
...
declare namespace chrome {
  ...
  export namespace tabs {
     ...
     * @param callback
     * @param callback.tab Details about the duplicated tab. The {@link tabs.Tab} object does not contain <code>url</code>, <code>pendingUrl</code>, <code>title</code>, and <code>favIconUrl</code> if the <code>"tabs"</code> permission has not been requested.
     */
    ...
    export function query(
      queryInfo: {
        ...
        /**
         * The ID of the group that the tabs are in, or {@link
     ...
     * @param updateProperties
     * @param callback
     * @param callback.tab Details about the updated tab. The {@link tabs.Tab} object does not contain <code>url</code>, <code>pendingUrl</code>, <code>title</code>, and <code>favIconUrl</code> if the <code>"tabs"</code> permission has not been requested.
     */
    export function update(
      tabId: number,
      updateProperties: {
     ...
     * @param options
     * @param callback
     * @param callback.groupId The ID of the group that the tabs were added to.
     */
    ...
    /**
     * Removes from a page CSS that was previously injected by a call to {@link
     * tabs.insertCSS}.
 ...
 */
  export namespace tts {
    ...
    export interface TtsOptions {
       ...
       * utterance.
       * @param onEvent.event The update event from the text-to-speech engine indicating the status of this utterance.
       */
      onEvent?: (
        event: TtsEvent,
      ) => void;
...
declare namespace chrome {
  ...
  export namespace webviewTag {
    ...
    export interface ContextMenus {
       ...
       * will be in {@link runtime.lastError}).
...
declare namespace chrome {
  ...
  export namespace windows {
    ...
    export const onBoundsChanged: chrome.events.Event<
      /**
       * @param window Details of the window. The tabs will not be populated for the window.
       */
      (
        window: Window,
      ) => void
