...
module.exports = eleventyConfig => {
  ...
  eleventyConfig.addNunjucksAsyncShortcode('ImplementationStatus', new ImplementationStatus().configure({
    eleventyConfig,
    templatePath: path.join(__dirname, 'site/_includes/shortcodes/implementationStatus.njk'),
    cacheTimeout: '3h',
  }));
