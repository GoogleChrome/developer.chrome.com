...
KEEP=100  # keep 100, App Engine's limit is 1100
...
#   20201207t043317
# (8 digits, "t", 6 digits).
# ... as these are autogenerated by gcloud.
#
# We need this for chrome-apps-doc as there are old manual versions we do not
# want to delete.
