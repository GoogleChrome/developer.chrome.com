...
const url = 'https://sheets.googleapis.com/v4/spreadsheets/1S_Apr0HavFCO7H9hKcRjIUrgoT7MFRg4uBm7aWSoaYo/values/Sheet2?key=AIzaSyCkROWBarEOJ9hQJggyrlUFulOFA4h6AW0&alt=json';
...
async function run() {
  ...
  if (!r.ok) {
    throw new Error(`Could not fetch fugu showcase entries, status: ${r.status}`);
  }
